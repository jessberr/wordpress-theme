  ...
  <div class="container"> 
    <section class="slideshow">
      <div class="white-overlay">
        ...
        <h4 id="example-description">CHECKOUT MY PROCESS OF BUILDING A CUSTOM THEME FOR MY SITE.</h4>
        <a href="/portfolio"><button>Read now</button></a>
      </div>
    ...
    <section id="gray-background">
      ...
      <div id="polariod-two">
        <div class="white-overlay">
          <a href="#"><h3 id="example-description">RESUME</h3></a>
        </div>
      </div>
