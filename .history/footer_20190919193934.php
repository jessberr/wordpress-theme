<footer class="wrapper footer">
   <div class="three-sections">
     <div class="section" id="one">
       ...
       <p>Ready for a website change or customization? Upgrade your web presence to be more responsive and clean. Get your webpage a makeover or customized today with <a href="/portfolio">jessberrett.com</a>!  </p>
     </div>
