  ...
  <div class="container"> 
    <section class="slideshow">
      <div class="white-overlay">
        <h3 id="example-title">LIKE THIS LAYOUT?<br>I BUILT IT</h3>
        <h4 id="example-description">Checkout my process of how I made my own website and how I can help make yours!</h4>
